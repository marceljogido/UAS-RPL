                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <ul>
                                                                            <li><span style="font-weight: bold;">Nama : </span> <?php echo $order['client_name']; ?></li>
                                                                            <li><span style="font-weight: bold;">Nomor Meja : </span><?php echo $order['client_phone']; ?></li>
                                                                            <li><span style="font-weight: bold;">Metode Pembayaran : </span><?php echo $order['client_email']; ?></li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </div>
