        ...
        <?php
            ...
            if(isset($_POST['submit_order_food_form']) && $_SERVER['REQUEST_METHOD'] === 'POST')
            {
                ...
                try {
                    ...
                    // Insert selected menus into in_order table
				                                    	...
				                                    	<div class="select_item_bttn">
				                                    		<div class="btn-group-toggle" data-toggle="buttons">
																<label class="menu_label item_label btn btn-secondary">
																	<input type="checkbox"  name="selected_menus[]" value="<?php echo $row['menu_id'] ?>" autocomplete="off">Jumlah
																</l0abel>
															
                                                            
                                                                <button type="button" class="btn btn-secondary btn-sm" onclick="decreaseQuantity(<?php echo $row['menu_id']; ?>)">-</button>
                                                                <input type="text" name="quantity[<?php echo $row['menu_id']; ?>]" id="quantity_<?php echo $row['menu_id']; ?>" value="0" readonly style="width: 30px; text-align: center;">
                                                                <button type="button" class="btn btn-secondary btn-sm" onclick="increaseQuantity(<?php echo $row['menu_id']; ?>)">+</button>
...
<div class="client_details_tab order_food_tab" id="clients_tab">
    ...
    <div>
        <div class="form-group row">
            <div class="col-sm-12">
                <input type="text" name="client_full_name" id="client_full_name" oninput="document.getElementById('required_fname').style.display = 'none'" onkeyup="this.value=this.value.replace(/[^\sa-zA-Z]/g,'');" class="form-control" placeholder="Nama">
        ...
        <div class="form-group row">
            <div class="col-sm-6">
                <input type="text" name="client_email" id="client_email" oninput="document.getElementById('required_email').style.display = 'none'" class="form-control" placeholder="Nomor Meja">
                <div class="invalid-feedback" id="required_email">
                    Invalid!
                </div>
            </div>
            <div class="col-sm-6">
                <input type="text" name="client_phone_number" id="client_phone_number" oninput="document.getElementById('required_phone').style.display = 'none'" class="form-control" onkeyup="this.value=this.valuereplace(/[^\sa-zA-Z]/g,'');" placeholder="Metode Pembayaran (QRIS / Tunai)">
                <div class="invalid-feedback" id="required_phone">
                    Ketik QRIS atau Tunai!
                </div>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        <img src="Design/images/wie logo.png" alt="Restaurant Logo" style="width: 150px;margin-bottom: 20px;">
                        <p>
                        Wie food menunggu kehadiran kalian!
                        </p>
                ...
                <div class="col-lg-3 col-md-6">
                     <div class="footer_widget">
                        <h3>Headquarters</h3>
                        <p>
                            Jl. Pendidikan No.20 Cibiru Wetan
                        </p>
                        <p>
                            wiefood@gmail.com
                            <br>
