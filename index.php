...
?>
			...
			<div class="row" style="flex-wrap: nowrap;">
				<div class="col-md-6 home-left-section">
					<div style="padding: 100px 0px; color: white;">
						...
						<hr>
						<p>
							Makan enak di perut ramah juga di kantong  
						</p>
			...
			<div class="row">
				<div class="col-md-4">
					<div class="our_qualities_column">
	                    <!-- <img src="/assets/image/logo makanan.png" > -->
	                    <div class="caption">
	                        <h3>
	                        MAKANAN KHAS ANAK MUDA
	                        </h3>
	                        <p>
	                        Saat ini, dari anak-anak hingga dewasa suka nongkrong dong di restoran? 
							apapun aktivitasnya, makannya harus yang berkualitas tinggi dong? 
							wie food menyediakan banyak pilihan makanan. Pengen tau? pesen aja sekarang!
	                        </p>
	                    </div>
	                </div>
				</div>
				<div class="col-md-4">
					<div class="our_qualities_column">
	                    ...
	                    <div class="caption">
	                        ...
	                        <p>
	                        Kalau makanan udah mantep masa ga ada minuman yakan?
							apalagi minuman yang paling ditunggu-tunggu orang, pasti minuman dingin
							banyak es batu dan tentunya bisa hilangin dahaga bener?
							liat minuman yang tersedia di wie food dong! menyegarkan!!
	                        </p>
	                    </div>
	                </div>
				</div>
				<div class="col-md-4">
					<div class="our_qualities_column">
	                    ...
	                    <div class="caption">
	                        <h3>
	                            DESSERT ENAK & PAS DI MULUT
	                        </h3>
	                        <p>
	                        Makanan minuman udah cucok nih...
							dessert ga mau kalah dong! makanan penutup atau biasa di pesen buat ngemil doang mah banyak di wie food
							pilih sambil merem juga ga bakal nyesel deh, dijamin!
	                        </p>
	                    </div>
	                </div>
				</div>
	...
	<section class="image-gallery" id="gallery">
		<div class="container">
			<h2 style="text-align: center;margin-bottom: 30px">OUR RESTO</h2>
			<?php
